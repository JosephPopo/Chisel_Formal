...
### file%3A%2F%2F%2Fhome%2Fjoseph%2FChisel_Formal%2Fbuild.sbt:35: error: ) expected but true found
...
lazy val root = (project in file("."))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "edu.berkeley.cs" %% "chiseltest" % "6.0-SNAPSHOT" % "test",
    ),
...
lazy val publishSettings = Seq(r
  publishMavenStyle := true,
