...
### file%3A%2F%2F%2Fhome%2Fjoseph%2FChisel_Formal%2Fbuild.sbt:35: error: ) expected but . found
...
lazy val root = (project in file("."))
  .settings(
    ...
    addCompilerPlugincompilerPlugin(("org.chipsalliance" % "chisel-plugin" % chiselVersion).cross(CrossVersion.full))
    resolvers ++= Resolver.sonatypeOssRepos("snapshots"),
